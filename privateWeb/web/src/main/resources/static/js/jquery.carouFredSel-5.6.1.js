...
(function ($) {
    ...
    $.fn.carouFredSel = function (options, configs) {
        ...
        $cfs._cfs_init = function (o, setOrig, start) {
            ...
            if (_typeof(o.items) != 'object') o.items = {};
            if (setOrig) opts_orig = $.extend(true, {}, $.fn.carouFredSel.defaults, o);

            opts = $.extend(true, {}, $.fn.carouFredSel.defaults, o);

            if (_typeof(opts.items.visibleConf) != 'object') opts.items.visibleConf = {};
            ...
            //	check visible items
            switch (_typeof(opts.items.visible)) {
        ...
        $cfs._cfs_bind_events = function () {
            ...
            $cfs.bind(cf_e('prev', conf) + ' ' + cf_e('next', conf), function (e, obj, num, clb) {
                ...
                if ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) != 'object' || obj == null) obj = opts[eType];
            ...
            $cfs.bind(cf_e('slide_prev', conf), function (e, sO, nI) {
                ...
                if (opts.usePadding) {
                    ...
                    if (l_new.not(l_cur).length) {
                        ...
                        if (pL < 0) l_cur.css(a_cur);else scrl.anims.push([l_cur, a_cur]);
                    }
                ...
                //	complete callback
                var a_complete = function a_complete() {
            ...
            $cfs.bind(cf_e('slideTo', conf), function (e, num, dev, org, obj, dir, clb) {
                ...
                if (num == 0) return;
                if ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) != 'object') obj = false;

                if (crsl.isScrolling) {
                    if ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) != 'object' || obj.duration > 0) return false;
                }

                if (dir != 'prev' && dir != 'next') {
                    if (opts.circular) {
                        if (num <= itms.total / 2) dir = 'next';else dir = 'prev';
                    } else {
                        if (itms.first == 0 || itms.first > num) dir = 'next';else dir = 'prev';
                    }
                }
            ...
            $cfs.bind(cf_e('jumpToStart', conf), function (e, s) {
                e.stopPropagation();
                if (s) s = gn_getItemIndex(s, 0, true, itms, $cfs);else s = 0;
            ...
            $cfs.bind(cf_e('insertItem', conf), function (e, itm, num, org, dev) {
                ...
                if ((typeof itm === 'undefined' ? 'undefined' : _typeof(itm)) == 'object' && typeof itm.jquery == 'undefined') itm = $(itm);
                if (typeof itm == 'string') itm = $(itm);
                if ((typeof itm === 'undefined' ? 'undefined' : _typeof(itm)) != 'object' || typeof itm.jquery == 'undefined' || itm.length == 0) return debug(conf, 'Not a valid object.');
            ...
            $cfs.bind(cf_e('currentPosition', conf), function (e, fn) {
                e.stopPropagation();
                if (itms.first == 0) var val = 0;else var val = itms.total - itms.first;
            ...
            $cfs.bind(cf_e('currentPage', conf), function (e, fn) {
                ...
                if (itms.first == 0) var nr = 0;else if (itms.first < itms.total % ipp) var nr = 0;else if (itms.first == ipp && !opts.circular) var nr = max;else var nr = Math.round((itms.total - itms.first) / ipp);
                if (nr < 0) nr = 0;
                if (nr > max) nr = max;
            ...
            $cfs.bind(cf_e('linkAnchors', conf), function (e, $con, sel) {
                ...
                if ((typeof $con === 'undefined' ? 'undefined' : _typeof($con)) != 'object') return debug(conf, 'Not a valid object.');
            ...
            $cfs.bind(cf_e('updateSizes', conf), function (e) {
                ...
                if (opts.items.visibleConf.variable) vI = gn_getVisibleItemsNext(a_itm, opts, 0);else if (opts.items.filter != '*') vI = gn_getVisibleItemsNextFilter(a_itm, opts, 0);
    ...
    function cf_sortParams(vals, typs) {
        ...
        for (var a = 0, l1 = vals.length; a < l1; a++) {
            for (var b = 0, l2 = typs.length; b < l2; b++) {
                if (typs[b].indexOf(_typeof(vals[a])) > -1 && typeof arr[b] == 'undefined') {
                    arr[b] = vals[a];
                    break;
                }
            }
    ...
    function cf_getPadding(p) {
        ...
        if (typeof p == 'number') return [p, p, p, p];else if (typeof p == 'string') p = p.split('px').join('').split('em').join('').split(' ');
