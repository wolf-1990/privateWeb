...
import com.bluesky.zhz.core.bean.page.JqGridReturnedData;
import com.bluesky.zhz.core.bean.page.JqGridUtils;
...
public class JsonUtils {
    ...
    public static <T> Map<String, Object> transformPageJson(List<T> list){
        ...
        JqGridReturnedData<T> returnedData = new JqGridReturnedData<T>(pages);
