...
public class BigDecimalUtil {
	 ...
	 * @return 和
	 */
	public static BigDecimal addBigDecimal(BigDecimal... params) {
		BigDecimal b1 = new BigDecimal(0);
	 ...
	 * @return
	 */
	public static double addStr(String... params) {
		BigDecimal b1 = new BigDecimal(0);
		for (String param : params) {
			if(!StringUtil.isBlank(param)){
				BigDecimal b2 = new BigDecimal(param);
				b1 = b1.add(b2);
			}
		}
		return b1.doubleValue();
	 ...
	 * @return
	 */
	public static double subOver(double num,double... params){
	...
	public static double div(double v1, double v2, int scale) {
		...
		//被除数必须大于0
		if (v2 == 0) {
			throw new ValidateException(ErrorCode.BUSSINESS_ERROR_0002,"除数不能等于0");
		}
