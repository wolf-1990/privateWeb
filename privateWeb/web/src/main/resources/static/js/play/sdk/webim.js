...
var webim = { // namespace object webim
    ...
    (function(webim) {
        ...
        var curSeq =0;//消息seq
            ...
            //表情对象，用户可以自定义
            var emotions = {
                "0":["[礼物]", "http://static.gensee.com/webcast/static/emotion/chat.gift.png"],
                "1":["[愤怒]", "http://static.gensee.com/webcast/static/emotion/emotion.angerly.gif"],
                "2":["[鄙视]", "http://static.gensee.com/webcast/static/emotion/emotion.bs.gif"],
                "3":["[伤心]", "http://static.gensee.com/webcast/static/emotion/emotion.cry.gif"],
                "4":["[再见]", "http://static.gensee.com/webcast/static/emotion/emotion.goodbye.gif"],
                "5":["[高兴]", "http://static.gensee.com/webcast/static/emotion/emotion.laugh.gif"],
                "6":["[流汗]", "http://static.gensee.com/webcast/static/emotion/emotion.lh.gif"],
                "7":["[无聊]", "http://static.gensee.com/webcast/static/emotion/emotion.nod.gif"],
                "8":["[疑问]", "http://static.gensee.com/webcast/static/emotion/emotion.question.gif"],
                "9":["[你好]", "http://static.gensee.com/webcast/static/emotion/emotion.smile.gif"],
                "10":["[反对]", "http://static.gensee.com/webcast/static/emotion/feedback.against.gif"],
                "11":["[赞同]", "http://static.gensee.com/webcast/static/emotion/feedback.agreed.png"],
                "12":["[鼓掌]", "http://static.gensee.com/webcast/static/emotion/feedback.applaud.png"],
                "13":["[太快了]", "http://static.gensee.com/webcast/static/emotion/feedback.quickly.png"],
                "14":["[太慢了]", "http://static.gensee.com/webcast/static/emotion/feedback.slowly.png"],
                "15":["[值得思考]", "http://static.gensee.com/webcast/static/emotion/feedback.think.png"],
                "16":["[凋谢]", "http://static.gensee.com/webcast/static/emotion/rose.down.png"],
                   "17":["[鲜花]", "http://static.gensee.com/webcast/static/emotion/rose.up.png"] 
                };
            //工具类
        ...
        Msg.Elem.Text = function(text) {
            this.text =text;//tool.xssFilter(text);
        };
